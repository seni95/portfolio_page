      ...
      <div className="w-full">
        <Slider ref={c => (this.slider = c)} {...settings}>
          <div className="w-5/6">
            ...
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/story1.jpg`} />
          </DescShow>
          </div>

          <div className="w-5/6">
            <DescShow desc={`카페 갔다가 친구가 찍어준 사진이예요!!`} hoverType={"regular"}>
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/story5.jpg`} />
          </DescShow>
          </div>
          ...
          <div className="w-5/6">
            ...
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/story2.jpg`} />
          </DescShow>
          </div>

          <div className="w-5/6">
            <DescShow desc={`아늑한 제 방 침대의 모습`} hoverType={"regular"}>
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/story3.jpg`} />
          </DescShow>
          </div>

          <div className="w-5/6">
            <DescShow desc={`제가 키우는 고양이 세라예요! 올해 3살 되었습니다.`} hoverType={"regular"}>
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/sera2.jpg`} />
          </DescShow>
          </div>
          ...
          <div className="w-5/6">
            ...
            <img className="w-full h-96 p-5 brightness-75" src={`${process.env.PUBLIC_URL}/img/story4.jpg`} />
          </DescShow>
          </div>
